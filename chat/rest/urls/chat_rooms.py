...
urlpatterns = [
    ...
    path(
        ...
        GroupChatMember.as_view(),
        name="group-chat-member-list",
    ),
    path(
        "/group-chat/<uuid:chat_room_uid>/members/<uuid:member_ship_uid>",
        GroupChatMemberDetail.as_view(),
        name="group-chat-member-detail",
    ),
